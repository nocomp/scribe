...
<div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:32px 36px;width:360px;box-shadow:0 4px 24px rgba(0,0,0,.08);display:flex;flex-direction:column;gap:12px">
  ...
  <div style="font-family:monospace;font-size:9px;color:#94a3b8;text-align:center;margin-top:8px">© Centre Hospitalier example hospital — SCRIBE Crisis OS<br>Accès réservé aux personnels autorisés</div>
</div>
</div>
<script>
(async function() {
