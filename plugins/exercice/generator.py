    ...
    {{
      ...
      "joueurs": [
        {{
          ...
          "display_name": "Directeur de Crise DEMO",
...
- Les ports : DEMO=8660, HOSPITAL-B=8661, HOSPITAL-C=8662, HOSPITAL-D=8663, HOSPITAL-E=8664, HOSPITAL-F=8665, HOSPITAL-G=8666
...
async def generate_scenario(
    ...
    sites_str = ", ".join(sites) if sites else "DEMO"
